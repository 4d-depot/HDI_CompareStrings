...
Case of 
	...
	Else 
		...
		$options.title:="Compare strings and find their positions ?"
		
		$options.blog:="blog.4d.com"
		$options.info:="4D Language"  //ex : "4D View Pro feature"
		
		$options.minimumVersion:="1860"  // 1860 means 18R6   1804 means 18.4 (do not use !)
